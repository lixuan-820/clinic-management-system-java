...
public class cmtHisGUI extends javax.swing.JFrame {

    private static Customer customerId;
    private DefaultTableModel model;

    public cmtHisGUI() { this(null); }

    public cmtHisGUI(Customer customerId) {
        this.customerId = customerId;
        initComponents();
        setTitle("Comment Histories");
        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        setLocationRelativeTo(null);

        model = new DefaultTableModel(new Object[]{"EmployeeID", "Comment", "Comment Date"}, 0) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EmployeeID", "Comment", "Comment Date"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel1.setText("Comment Histories");
    ...
    private void loadForCustomer(String custId) {
        model.setRowCount(0);
        for (Comment c : Comment.loadAll(custId)) {
            model.addRow(new Object[]{ c.getUserID(), c.getContent(), c.getDate() });
        }
    }

    public static void main(String args[]) {
        SwingUtilities.invokeLater(() -> new cmtHisGUI(customerId).setVisible(true));
    }
